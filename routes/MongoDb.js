...
router.get('/', function (request, response) {
    ...
    mongodb.MongoClient.connect('mongodb+srv://admin:admin123@exercisen1.nrljg.mongodb.net/sample_express?retryWrites=true&w=majority', function(err, client) {
        ...
        var db = client.db('cars');  // in v3 we need to get the db from the client

        var Routes = db.collection('description');
